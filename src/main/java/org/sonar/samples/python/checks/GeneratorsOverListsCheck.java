...
public class GeneratorsOverListsCheck extends PythonSubscriptionCheck {
  ...
  private static final String MESSAGE = "Use generator expressions instead of list comprehensions when passing iterables to functions like 'sum()', 'any()', 'all()', 'min()', 'max()', or 'join()'. This avoids unnecessary memory allocation for list creation.";

  private static final Set<String> ITERABLE_CONSUMING_FUNCTIONS = Set.of("sum", "any", "all", "min", "max");
